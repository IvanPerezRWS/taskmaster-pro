...
var auditTask = function(taskEl) {
  ...
  // apply new vlass if task is near/over due date
...
// Sortable method (enable dragging across lists)
...
$("#modalDueDate").datepicker({
  // force user to selecte a future date
  minDate: 1
});
// modal was triggered
...
$(".list-group").on("click", "p", function() {
  ...
  // repkace p element with new textarea
